...
public class CardboardHead : MonoBehaviour
{
    ...
    public Quaternion tmpRot = Quaternion.identity;
    ...
    private void UpdateHead()
    {
        ...
        if (!isMulti)
        {
            if (trackRotation)
            {
                ...
                head.transform.rotation = Quaternion.Euler(rot.eulerAngles.z, rot.eulerAngles.y - 90, -rot.eulerAngles.x - 90);
                //            Debug.Log ("my z : " + rot.eulerAngles.z + "my y : " + rot.eulerAngles.z + "my x : " + rot.eulerAngles.z);
        ...
        if (trackPosition)
        {
            ...
            if (target == null)
            {
                transform.localPosition = Vector3.Lerp(transform.localPosition, transform.localPosition + transform.localRotation * pos, Time.deltaTime);
                //transform.localPosition = transform.localPosition + transform.localRotation * pos;
            }
            else
            {
